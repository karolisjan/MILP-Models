...
DISPLAY profit.l, Sold.l, TC.l, PC.l, BC.l, SC.l, CC.l, WC.l, FI.l, S.l, delta.l, CP.l, CT.l, FP.l, FT.l;

execute_unload   "results.gdx" CP FP  CI FI CW FW S delta Z X Y U CT FT;
execute  'Gdxxrw results.gdx output=Lakhdar2005.xlsm skipempty=0 zeroout=0 trace=2 index=Index!J7:L100';